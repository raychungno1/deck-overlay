...
for (let key in blueDeck) {
  ...
  track.overwriteClip(findShallow(`${blueDeck[key].name}.png`, cardsBin), 0);
...
// app.enableQE();
// $.writeln(seqName)
// const qep = qe.project;
// let qeSeqBin;
// for (let i = 0; i < qep.numBins; i++) {
//   qeSeqBin = qep.getBinAt(i);
//   if (qeSeqBin.name === "deck-overlay") {
//     break;
//   }
// }
// let qeSeq;
// for (let i = 0; i < qeSeqBin.numSequences; i++) {
//   qeSeq = qeSeqBin.getSequenceAt(i);
//   if (qeSeq.name === seqName) {
//     break;
//   }
// }
// $.writeln(qeSeq.name);
// const qeClip = qeSeq.getVideoTrackAt(i + 11).getItemAt(0);
// $.writeln(qeClip.name);
